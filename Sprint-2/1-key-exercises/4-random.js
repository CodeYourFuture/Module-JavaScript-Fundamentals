...
//4.math.floor() gives out the largest intiger which is less than or equal to
//  the given number,which is decimal, which means it drops all the decimal. forexample if 
